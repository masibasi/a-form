...
export default function Survey() {
  ...
  useEffect(() => {
    ...
    let response = {
      ...
      questions: "[{\"id\": 0,\"questionTitle\": \"test question\",\"questionType\": 1, \"item\": [\"test1\", \"test2\", \"test3\"]},{\"id\": 1,\"questionTitle\": \"test question2\",\"questionType\": 2,\"item\": [\"test4\", \"test5\", \"test6\"]},{\"id\": 3,\"questionTitle\": \"test question3\",\"questionType\": 3,\"item\": [\"test4\"]}]",
      author: 1
    };
    ...
    let answerForm = {
      ...
      userPK: 1,
      answer: Array.from(
        { length: response.questions.length },
        (_, i) => Array.from(
