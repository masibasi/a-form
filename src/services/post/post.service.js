...
export const CreateCategory = async (categoryType, postPk) => {
  ...
  const res = axios
    .post(`${POST_API_URL}/api/post/postCategory/create`, body)
...
export const GetPostCategory = async (postPk) => {
  const res = axios
    .get(`${POST_API_URL}/api/post/postCategory/get/${postPk}`)
    .then((res) => {
...
export const GetAllCategory = async () => {
  const res = axios
    .get(`${POST_API_URL}/api/post/category/getAll`)
    .then((res) => {
...
export const PostComment = async (commentAuthor, commentContent, postPk) => {
  ...
  const res = await axios
    .post(`${POST_API_URL}/api/post/comment/create`, newComment)
...
export const GetComments = async (postPk, size, page) => {
  const res = await axios
    .get(`${POST_API_URL}/api/post/comment/get/comments/${postPk}/${size}/${page}`)
    .then((res) => {
...
export const DeleteComment = async (commentPk) => {
  await axios
    .delete(`${POST_API_URL}/api/post/comment/delete/${commentPk}`)
    .then((res) => console.log(res))
    .catch((err) => console.log(err));
};
...
export const GetCommentCnt = async (postPk) => {
  const res = await axios
    .get(`${POST_API_URL}/api/post/comment/commentCnt/${postPk}`)
    .then((res) => {
